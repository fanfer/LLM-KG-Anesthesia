...
def get_graph_qa_chain(state: MedicalState):
...
def get_graph_qa_chain_with_context(state: MedicalState):
    
    """Create a Neo4j Graph Cypher QA Chain. Using this as MedicalState so it can access state['prompt']"""
