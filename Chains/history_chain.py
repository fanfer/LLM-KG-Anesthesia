...
【病史收集】：询问病人疾病史，对于了解到的病史，询问其具体疾病及治疗情况。
    ...
    - 了解患者是够有已知会增加并发症风险的其他疾病，尤其是脑血管病、糖尿病等。
    - 询问患者近期是否有感冒、发热、局部红肿等症状。
    - 了解患者是否有传染性疾病，如甲肝、乙肝等。
    - 了解患者是否有异常出血史（牙龈/皮下等），是否使用抗凝药物。
...
4.气道评估 （患者不清楚正常与否的具体标准，加入具体解释）
  ...
  -张口度：正常（你张嘴能放入3根手指）；异常（你张嘴时只能放进两根或更少）
  -牙齿：正常；松动；缺；义齿
  -睡觉打鼾：否；是
5.询问患者术前的的禁食、禁水情况。如果禁食禁水时间较长，需要追问在病房的补液情况。
6.对于老年人询问是否有长期卧床或者活动能力受限的情况。
7.对于老年男性患者，需要了解患者的前列腺疾病或手术史，对于年轻男性患者和女性患者不需要了解。
8.对于女性患者，询问是否怀孕，如果怀孕，则询问怀孕时间，预产期，是否存在流产史，是否存在早产史，是否存在剖宫产史。
